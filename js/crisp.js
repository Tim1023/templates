    ...
    try {
        ...
        new (function () {
            ...
            return t.prototype.init = function () {
                var t = this, e = "init";
                try {
                    if (this.__website_id && this.__initialize_fired !== !0) if (this.__initialize_fired = !0, window.innerWidth && window.innerWidth < this.__width_threshold) ; else if (navigator.cookieEnabled !== !0) ; else if (this.__is_domain_banned(this.__page_domain) === !0) ; else {
                ...
                try {
                    this.__include_preconnect(this.__url_relay_client), this.__include_preconnect(this.__url_settings), this.__include_preconnect(this.__url_assets), this.__include_preconnect(this.__url_image), this.__include_client_javascripts(), this.__include_client_stylesheets()
                } catch (e) {
                    this.__console.error(this.ns + "." + t, e)
                }
            }, t.prototype.__include_preconnect = function (t) {
                var e = "__include_preconnect";
                try {
                    var _ = document.createElement("link");
                    _.setAttribute("href", t), _.setAttribute("rel", "preconnect"), _.setAttribute("crossorigin", ""), this.__apply_include_attrs(_), document.getElementsByTagName("head")[0].appendChild(_)
                } catch (t) {
                    this.__console.error(this.ns + "." + e, t)
                }
                ...
                try {
                    ...
                    e.src = "/js/client.js", e.type = "text/javascript", e.async = 1, this.__apply_include_attrs(e), document.getElementsByTagName("head")[0].appendChild(e)
                } catch (e) {
                    this.__console.error(this.ns + "." + t, e)
                }
                ...
                try {
                    var e = this.__detect_include_mode(), _ = document.createElement("link");
                ...
                var t = "__detect_website_id_from_dom", e = null;
                try {
                ...
                var t = "__detect_include_mode", e = "default";
                try {
                    var _ = (navigator.userAgent || "").toLowerCase(), i = (navigator.appVersion || "").toLowerCase(),
                ...
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", e = "__is_domain_banned",
                    _ = !1;
                try {
                    if (t) for (var i = 0; i < this.__circuit_breaker.domains.length; i++) {
                        var r = this.__circuit_breaker.domains[i], n = "." + r;
                ...
                var t = "__list_browser_locales", e = [];
                try {
